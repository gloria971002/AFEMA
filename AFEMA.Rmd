...
#df <- read.csv("C:/Users/32631/Desktop/A BU/A615/Combo/PublicAssistanceFundedProjectsDetails.csv", header = TRUE)
...
ds <- df
## forcus on the frequency distribution of damage in different states, using donut chart
...
```{r,warning=FALSE,message=FALSE}
## focus on the distribution of damage category, using donut chart
dd <- df
